        ...
        mRegister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!isEmpty(mEmail.getText().toString())
                    ...
                    Toast.makeText(Register_Activity.this, "You must fill out all the fields", Toast.LENGTH_SHORT).show();
                }
            }
        });
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if(task.isSuccessful()){
                                Toast.makeText(Register_Activity.this, "Sent Verification Email",
                                        Toast.LENGTH_SHORT).show();
                            }else{
                                Toast.makeText(Register_Activity.this, "Couldn't Send Verification Email",
                                        Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        ...
        FirebaseAuth.getInstance().createUserWithEmailAndPassword(email, password)
                .addOnCompleteListener(new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        ...
                        if (!task.isSuccessful()) {
                            Toast.makeText(Register_Activity.this, "Unable to Register",
                                    Toast.LENGTH_SHORT).show();
                        }
                        hideDialog();
